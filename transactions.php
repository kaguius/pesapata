<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "Transactions Charge Report";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
		...
		if ($filter_start_date != "" && $filter_end_date != ""){
			$page_title = "Transaction Charge Report";
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<p>Export: <a href="excel_print.php?filter_start_date=<?php echo $filter_start_date ?>&filter_end_date=<?php echo $filter_end_date ?>&file=transactions"><img src="images/excel.jpeg" width="25px"></a></p>
						...
						<tr>
							<td width="100%" bgcolor="#F8F2F2" style="border: 1px dotted #C5D6FC; padding-left:2px;">
								<div class='example awesome'>
							  	<div id="transactions" style="width: 950px; height: 400px;"></div>
								</div>
							</td>
