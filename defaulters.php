		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<p>Export: <a href="excel_print.php?filter_start_date=<?php echo $filter_start_date ?>&filter_end_date=<?php echo $filter_end_date ?>&file=defaulters"><img src="images/excel.jpeg" width="25px"></a></p>
						...
						<tr>
							<td width="100%" bgcolor="#F8F2F2" style="border: 1px dotted #C5D6FC; padding-left:2px;">
								<div class='example awesome'>
							  	<div id="defaulters" style="width: 950px; height: 400px;"></div>
								</div>
							</td>
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
						...
						<tbody>
						<?php
						 $sql = mysql_query("select loan_application.Loan_mobile, Loan_Sched_Loan_ID, loan_sched_id, Loan_Sched_Type, loan_sched_due_amount, Loan_Sched_Due_Date, Loan_Sched_Paid_Amount from loan_schedule inner join loan_application on loan_application.Loan_id = loan_schedule.Loan_Sched_Loan_ID where Loan_Sched_Due_Date between '$filter_start_date' and '$filter_end_date' and Loan_Sched_Paid_Amount = '0'");
						 $total_invoice = 0;
						 $intcount = 0;
