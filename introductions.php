		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<?php
					$sql3 = mysql_query("select distinct Introduction_Introducer_Mobile, users.Client_Name from introduction inner join users on users.Client_Mobile = introduction.Introduction_Introducer_Mobile where Introduction_Introducer_Mobile = '$username' order by users.Client_Name asc");
					$intcount = 0;
					$intro_percent = 0;	
