<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "Communications Report";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<p>Export: <a href="excel_print.php?filter_start_date=<?php echo $filter_start_date ?>&filter_end_date=<?php echo $filter_end_date ?>&file=ussd"><img src="images/excel.jpeg" width="25px"></a></p>
